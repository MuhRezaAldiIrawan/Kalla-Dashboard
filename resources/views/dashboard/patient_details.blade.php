			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					...
					<div class="d-flex">
						...
						<a href="{!! url('/app-profile'); !!}" class="btn btn-outline-primary">Update Profile</a>
					</div>
				</div>
				<div class="row">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card details-card">
									<img src="{{ asset('images/bg.jpg') }}" alt="" class="bg-img">
									<div class="card-body">
										<div class="d-sm-flex mb-3">
											...
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													<h2 class="font-w600 mb-2 text-black">Samuel Hawkins Sitepu</h2>
											...
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														...
														<p class="fs-18 mb-0 text-black">795 Folsom Ave, Suite 600 San Francisco, <strong class="d-block">CADGE 94107</strong></p>
													</div>
												</div>
											</div>
											<div class="col-sm-5">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="media mb-4 align-items-center">
											<img src="{{ asset('images/users/12.jpg') }}" alt="" width="85" class="mr-3">
											<div class="media-body">
